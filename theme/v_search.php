				...
				<div class="breadcrumbs">
					<ul class="breadcrumbs__list">
						...
						<li class="breadcrumbs__item">
							<span class="breadcrumbs__nolink">Результаты поиска по запросу: <?=$query?></span>
						</li>
					</ul>
				</div>
				<h3 class="content__title">Поиск товаров</h3>
					...
					<div class="cat-products">
						...
						<?php else :?>
							<div>
								...
								<p>Товаров не найдено, попробуйте использовать другой запрос.</p>
							</div>
						<?php endif; ?>
					</div>
				</div>
