...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<ol class="breadcrumb">
					...
					<li class="active"><i class="fa fa-cart-plus"></i> Добавить товар</li>
		...
		<div class="row">
			<form action="?view=add_product&csrf_token=<?=$_SESSION['auth']['csrf_token']?>" method="POST" role="form" enctype="multipart/form-data">
				<div class="col-lg-8">		
					...
					<div class="form-group">
						...
						<input id="article" autocomplete="off" class="form-control" name="article" value="<?=_arg('article')?>">
					</div>
					...
					<div class="form-group">
						...
						<input style="width:200px;display:inline;" id="sm_price_m" type="number" class="form-control" name="price" placeholder="5000" value="<?=_arg('price')?>">
					...
					<div class="form-group">
						...
						<input style="width:200px;display:inline;" id="sm_price_m" type="number" class="form-control" name="discount" placeholder="10" value="<?=_arg('discount')?>">
					...
					<div class="form-group">
						...
						<label for="visible">Скрыть товар?</label> Да&nbsp;<input id="visible" type="radio" name="visible" value="0"<?=(_arg('visible')===0?' checked="checked"':'')?>>&nbsp;&nbsp;Нет&nbsp;<input type="radio" name="visible" value="1"<?=(_arg('visible')?' checked="checked"':'')?><?=(_arg('visible')===false?' checked="checked"':'')?>>
					</div>
					...
					<div class="form-group" style="border: 1px dashed #d9534f;padding: 8px;">
						...
						<input id="productpicture" type="file" name="productpicture">
					</div>
					<?php endif; ?>
					...
					<div class="form-group" style="border: 1px dashed #d9534f;padding: 8px;">
						...
						<div id="productgallery">
							<div><input type="file" name="productgallery[]" /></div>
						</div>
					...
					<div class="form-group">
						...
						<textarea id="product-text" class="form-control" name="text"><?=_arg('text')?></textarea>
						<script type="text/javascript">
							tinymce.init({
			...
			<div class="col-lg-4" style="margin-bottom:10px;">
				<div class="side-module">
					...
					<?php if (is_array(_arg('simular'))): ?>
						<?php foreach(_arg('simular') as $k => $v): ?>
						<div><span class="remove_item">ID#: <?=$v?>&nbsp;<i class="fa fa-trash"></i></span><input type="hidden" name="simular[]" value="<?=$v?>"></div>
						<?php endforeach; ?>
					<?php endif; ?>
					</div>
			...
			<div class="col-lg-4" style="margin-bottom:10px;">
				<div class="side-module">
					...
					<div class="module-box">
						<?=createCheckboxObjectsTree($objects, 'cat', 0, 0, (_arg('cats') != false && is_array(_arg('cats'))?_arg('cats'):[]))?>
					</div>
				</div>
			</div>
			<?php endif; ?>
